document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    zh: {
      ...
      "section.what.desc":"我們不只是提供建議，而是以陪跑夥伴的角色，協助企業從市場判斷、合作設計到實際落地，建立可長期經營的合作基礎。",
      "section.experience.desc":"從事業開發到冷鏈物流合作，SynerSeed 重視可落地的流程、穩定的夥伴關係，以及能被持續延伸的長期價值。",
      "section.leadership.desc":"以顧問與陪跑夥伴的角色，協助企業理解日本商務語境，將信任、判斷與行動轉化為可執行的合作共識。",
      "leader.role":"顧問 | Business Development Partner",
    ...
    ja: {
      ...
      "cta.contact":"お問い合わせ",
      "hero.line":"意思決定の鍵は構造。","hero.desc":"信頼を築き、構造を設計し、台湾と日本の間にある事業機会を実行と成長へつなげます。",
      ...
      "service.ln.title":"物流ネットワーク","service.ln.desc":"日本の物流ネットワークとコールドチェーン資源を連携し、安定した物流協業体制を構築します。",
      "section.what.desc":"私たちは単に助言を提供するのではなく、伴走パートナーとして、市場判断、協業設計から実行までを支援し、長期的に成長できる協業基盤を築きます。",
      "section.experience.desc":"事業開発からコールドチェーン物流連携まで、SynerSeed は実行可能なプロセス、安定したパートナー関係、そして継続的に広がる長期価値を重視します。",
      "section.leadership.desc":"顧問・伴走パートナーとして、日本のビジネス文脈を理解し、信頼・判断・行動を実行可能な協業の共通認識へとつなげます。",
      "leader.role":"顧問 | Business Development Partner",
      "exp.bd":"日本企業との事業開発支援","exp.logistics":"コールドチェーン物流連携",
      "leader.p1":"Sandy Lin は長期にわたり、台日間のビジネス開発、観光・レンタカー予約連携、商品およびコールドチェーン関連業務の推進に関わってきました。",
    ...
    en: {
      ...
      "section.what.desc":"We do more than provide advice. As a hands-on partner, we support companies from market assessment and partnership design through execution, building a foundation for long-term growth.",
      "section.experience.desc":"From business development to cold-chain logistics collaboration, SynerSeed focuses on executable processes, stable partnerships, and long-term value that can continue to grow.",
      "section.leadership.desc":"As a consultant and hands-on partner, we help companies navigate Japanese business context and turn trust, judgment and action into executable alignment.",
      "leader.role":"Consultant | Business Development Partner",
