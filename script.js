const translations = {
  zh: {
    ...
    contact: { title: 'Contact Us｜歡迎與我們聯繫', desc: '針對台日商務合作、物流服務、觀光合作與拓展日本市場需求，歡迎來信洽詢。' }
  },
  ja: {
    ...
    contact: { title: 'Contact Us｜お問い合わせ', desc: '日台間のビジネス提携、物流、観光連携、日本市場開拓に関するご相談を歓迎します。' }
  },
  en: {
